...
<body>
    ...
    <h2 align = "center"> Delete Customer Record </h2>
    ...
    if ($_SERVER['REQUEST_METHOD']== 'POST')
    {
        if ($_POST['sure'] == 'Yes')//Delete The Record
        {
            ...
            {
                echo '<script>alert("The Customer has NOT been deleted");
                window.location.href="customerList.php";</script>';
            }
    }
    else
    {
        ...
        $q = "SELECT customerName FROM customers WHERE customerID = $id";
        ...
        if (mysqli_num_rows($result) ==1)
        {
            ...
            echo '<form action = "customerDelete.php" method = "post">
